...
public class GradeCalculator extends JFrame {
    ...
    public GradeCalculator() {
        ...
        resultsArea = new JTextArea(14, 60);
    ...
    private void calculateGrades() {
        ...
        try {
            ...
            double maxAttendances = 7;
            double attendanceScore = (attendanceCount / maxAttendances) * 100;
            ...
            results.append(String.format("Attendance Score: %.2f (%.0f out of 7 attendances)\n", 
                attendanceScore, attendanceCount));
            ...
            if (requiredForPassing <= 0) {
                results.append(String.format("To Pass (75): You've already secured a passing grade! (Required: %.2f)\n", 
                    requiredForPassing));
            } else if (requiredForPassing > 100) {
                results.append(String.format("To Pass (75): %.2f - Unfortunately, passing is mathematically impossible with your current class standing.\n", 
                    requiredForPassing));
            } else {
            ...
            if (requiredForExcellent <= 0) {
                results.append(String.format("For Excellent (100): You've already secured an excellent grade! (Required: %.2f)\n", 
                    requiredForExcellent));
            } else if (requiredForExcellent > 100) {
                results.append(String.format("For Excellent (100): %.2f - This would require more than 100%% on the exam.\n", 
                    requiredForExcellent));
            } else {
